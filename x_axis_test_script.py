...
# From your printer.cfg: rotation_distance for stepper_x is 20
...
if __name__ == "__main__":
    ...
    print("\nPlease enter the desired scan range for the microscope (X-axis: 100-175).")
    ...
    while True:
        try:
            ...
            if not (100 <= start_x <= 175 and 100 <= end_x <= 175 and start_x <= end_x):
                print("Invalid X range. X positions must be between 100 and 175, and start_x <= end_x.")
            else:
